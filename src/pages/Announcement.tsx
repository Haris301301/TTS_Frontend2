    ...
    try {
      await client.entities.announcement_schedules.create({
        data: {
          ...
          day_of_week: repeatType === 'weekly' ? selectedDay : 'daily',
          time: scheduleTime,
          is_active: true,
          created_at: new Date().toISOString(),
        },
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-2">Kelola pengumuman dengan text-to-speech atau upload audio</p>
      </div>
        ...
        <div>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Atur jadwal pengumuman</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              {!showScheduleForm ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex space-x-2">
                    <Button onClick={handleAddSchedule} className="flex-1 bg-emerald-600 hover:bg-emerald-700">
                      Simpan
                    </Button>
                    <Button onClick={() => setShowScheduleForm(false)} variant="outline" className="flex-1">
                      Batal
                    </Button>
                  </div>
                </div>
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      {item.audio_type === 'generated' ? 'TTS Generated' : 'Uploaded'} • {new Date(item.created_at).toLocaleDateString('id-ID')}
                    </p>
                  </div>
                  <div className="flex space-x-2">
