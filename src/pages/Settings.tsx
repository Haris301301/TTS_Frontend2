  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-2">Kelola pengaturan umum aplikasi</p>
      </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  className="mt-2"
                />
                <p className="text-xs text-gray-500 mt-1">Atur volume audio default</p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Pilih zona waktu untuk jadwal</p>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Aktifkan pemutaran otomatis sesuai jadwal
                  </p>
                </div>
                <Switch id="autoplay" checked={autoPlayEnabled} onCheckedChange={setAutoPlayEnabled} />
              </div>
            </div>

            <Button onClick={handleSaveSettings} className="w-full bg-emerald-600 hover:bg-emerald-700">
